...
= Change Log =
* 3.0 - AJAX calls using site root url.
- Now compatible with ADMIN_FORCE_SSL
- Added an option to show Usernoise to registered users only
- Fixed a bug that prevented avatars from being shown sometimes.
- Added a code generator to use Usernoise from external site.
